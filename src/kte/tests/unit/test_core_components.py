...
class TestInputHandler:
    ...
    def test_process_file_input(self):
        ...
        with patch("kte.core.input_handler.FileUtils.extract_text_from_file") as mock_extract:
            mock_extract.return_value = ("File content", {"file_path": "test.txt"})

            result = handler.process_file_input("tests/resources/test.txt")
    ...
    def test_process_input_with_file(self):
        ...
        with patch("kte.core.input_handler.FileUtils.extract_text_from_file") as mock_extract:
            ...
            result = handler.process_input("tests/resources/test.txt")
